<nav class="flex fixed z-10 justify-between items-center lg:p-3 p-3 lg:px-[30px] bg-white shadow-md w-full">
    ...
    <i class="ri-menu-3-line text-slate-400 text-2xl md:hidden cursor-pointer"></i>
</nav>
